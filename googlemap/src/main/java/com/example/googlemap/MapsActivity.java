...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,LocationListener {
    ...
    private void havePermission() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            manager.requestLocationUpdates(LocationManager.PASSIVE_PROVIDER, 100, 0.1f, (LocationListener) this);
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        mMap.addCircle(new CircleOptions().center(myLoc).radius(100).strokeWidth(5).fillColor(Color.BLUE));
